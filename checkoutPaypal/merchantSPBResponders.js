(() => {
    var e = {
        4654: function(e, t, r) {
            ...
            const v = g(r(2081)), m = r(1614), w = r(3982), b = r(6068), x = "AES-CBC";
            t.PostMessenger = class {
                constructor({
                    ...
                    if (n.add(this), this.connection = null, o.set(this, void 0), 
                    i.set(this, {
                        algorithm: null,
                        iv: null,
                        requestKey: null
                    }), s.set(this, {}), this.targetWindow = null, this.targetOrigin = null, 
                    a.set(this, void 0), c.set(this, null), (0, v.default)(this), 
                    this.clientName = e, d(this, o, t, "f"), this.useEncryption = (e, t = !1) => {
                ...
                addListener(e, t) {
                    return y(this, s, "f")[e] ? y(this, s, "f")[e].push(t) : y(this, s, "f")[e] = [ t ], 
                ...
                connect({
                    ...
                    return l(this, void 0, void 0, function*() {
                        ...
                        c && (o = crypto.getRandomValues(new Uint8Array(16)), y(this, i, "f").requestKey = yield crypto.subtle.generateKey({
                            length: 256,
                            name: x
                        }, !0, [ "encrypt", "decrypt" ]), s = yield crypto.subtle.exportKey("jwk", y(this, i, "f").requestKey), 
                        y(this, i, "f").iv = o, y(this, i, "f").algorithm = {
                            iv: o,
                            name: x
                        });
                        const u = r || 1;
                        ...
                        return this.logger(`Connection established to ${this.connection.clientName}`, this.connection), 
                        !0;
                    });
                }
                acceptConnections({
                        ...
                        const t = y(this, n, "m", p).call(this, {
                            postMessengerConnect: (r, n) => l(this, void 0, void 0, function*() {
                                ...
                                if (this.setTarget(n.source, r.origin), this.connection = {
                                    ...
                                    this.connection.useEncryption = !0, y(this, i, "f").iv = new Uint8Array([ ...r.iv ]), 
                                    y(this, i, "f").algorithm = {
                                        iv: y(this, i, "f").iv,
                                        name: x
                                ...
                                return t(), this.logger(`Accepted connection from ${this.connection.clientName}`, this.connection), 
                                e(this.connection), {
                                    clientName: this.clientName,
                                    types: r.types,
                ...
                decrypt(e) {
                    return l(this, void 0, void 0, function*() {
                        ...
                        const t = (0, b.decodeBase64)(e), r = (0, b.str2ab)(t), n = yield crypto.subtle.decrypt(y(this, i, "f").algorithm, y(this, i, "f").requestKey, r);
                ...
                encrypt(e) {
                    return l(this, void 0, void 0, function*() {
                        ...
                        const t = new TextEncoder().encode(JSON.stringify(e)), r = yield crypto.subtle.encrypt(y(this, i, "f").algorithm, y(this, i, "f").requestKey, t), n = (0, 
                        b.ab2str)(r);
                        return (0, b.encodeBase64)(n);
                    });
                }
            }, o = new WeakMap(), i = new WeakMap(), s = new WeakMap(), a = new WeakMap(), 
            c = new WeakMap(), n = new WeakSet(), u = function(e = {}) {
                ...
                return l(this, void 0, void 0, function*() {
                    let i = r, s = o || null;
                    this.useEncryption(e, !0) && (i = yield this.encrypt(r), s && (s = yield this.encrypt(s))), 
                ...
                return l(this, void 0, void 0, function*() {
                    const o = (0, m.v4)();
                    return this.logger(`sending request type '${e}' to '${this.targetOrigin}':`, t), 
                    yield y(this, n, "m", h).call(this, e, o, t), new Promise((t, n) => {
                        let i = !1;
                        const s = this.addListener(e, r => l(this, void 0, void 0, function*() {
                            if ((0, w.isRequestMessage)(r) && r.messageId === o) if (i = !0, 
                            s(), r.isError) {
                ...
                return Object.entries(e).forEach(([ e, o ]) => {
                    const i = y(this, a, "f")[e], s = this.addListener(i, (e, r) => l(this, void 0, void 0, function*() {
                        ...
                        try {
                            ...
                            const t = yield o(s, r);
                            this.logger(`responding to request type '${i}' from target '${this.targetOrigin}':`, t), 
                            y(this, n, "m", h).call(this, i, e.messageId, t);
                        } catch (t) {
        ...
        3982: (e, t) => {
            ...
            t.isError = e => Boolean(e.message), t.isRequestMessage = e => Boolean(e && "object" == typeof e && !Array.isArray(e) && "string" == typeof e.type && "string" == typeof e.messageId && "boolean" == typeof e.isError && void 0 !== e.errorMessage), 
            function(e) {
        ...
        6068: (e, t) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.decodeBase64 = t.encodeBase64 = t.str2ab = t.ab2str = void 0, 
            t.ab2str = function(e) {
        ...
        1989: (e, t, r) => {
            var n = r(1789), o = r(401), i = r(7667), s = r(1327), a = r(1866);
            function c(e) {
            ...
            c.prototype.clear = n, c.prototype.delete = o, c.prototype.get = i, 
            c.prototype.has = s, c.prototype.set = a, e.exports = c;
        },
        8407: (e, t, r) => {
            var n = r(7040), o = r(4125), i = r(2117), s = r(7518), a = r(4705);
            function c(e) {
                var t = -1, r = null == e ? 0 : e.length;
                for (this.clear(); ++t < r; ) {
                    var n = e[t];
        ...
        3369: (e, t, r) => {
            var n = r(4785), o = r(1285), i = r(6e3), s = r(9916), a = r(5265);
            function c(e) {
                var t = -1, r = null == e ? 0 : e.length;
                for (this.clear(); ++t < r; ) {
                    var n = e[t];
        ...
        4239: (e, t, r) => {
            var n = r(2705), o = r(9607), i = r(2333), s = n ? n.toStringTag : void 0;
            e.exports = function(e) {
                return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : s && s in Object(e) ? o(e) : i(e);
            };
        },
        8458: (e, t, r) => {
            var n = r(3560), o = r(5346), i = r(3218), s = r(346), a = /^\[object .+?Constructor\]$/, c = Function.prototype, u = Object.prototype, h = c.toString, f = u.hasOwnProperty, p = RegExp("^" + h.call(f).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
            e.exports = function(e) {
                return !(!i(e) || o(e)) && (n(e) ? p : a).test(s(e));
            };
        },
        531: (e, t, r) => {
            var n = r(2705), o = r(9932), i = r(1469), s = r(3448), a = n ? n.prototype : void 0, c = a ? a.toString : void 0;
            e.exports = function e(t) {
        ...
        1811: (e, t, r) => {
            var n = r(1469), o = r(5403), i = r(5514), s = r(9833);
            e.exports = function(e, t) {
        ...
        9607: (e, t, r) => {
            var n = r(2705), o = Object.prototype, i = o.hasOwnProperty, s = o.toString, a = n ? n.toStringTag : void 0;
            e.exports = function(e) {
        ...
        5403: (e, t, r) => {
            var n = r(1469), o = r(3448), i = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, s = /^\w*$/;
            e.exports = function(e, t) {
                if (n(e)) return !1;
                var r = typeof e;
        ...
        5639: (e, t, r) => {
            var n = r(8450), o = "object" == typeof self && self && self.Object === Object && self, i = n || o || Function("return this")();
            e.exports = i;
        },
        5514: (e, t, r) => {
            var n = r(4523), o = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, i = /\\(\\)?/g, s = n(function(e) {
                var t = [];
        ...
        1614: (e, t, r) => {
            ...
            const s = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i, a = function(e) {
                return "string" == typeof e && s.test(e);
            };
            for (var c = [], u = 0; u < 256; ++u) c.push((u + 256).toString(16).substr(1));
            const h = function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, r = (c[e[t + 0]] + c[e[t + 1]] + c[e[t + 2]] + c[e[t + 3]] + "-" + c[e[t + 4]] + c[e[t + 5]] + "-" + c[e[t + 6]] + c[e[t + 7]] + "-" + c[e[t + 8]] + c[e[t + 9]] + "-" + c[e[t + 10]] + c[e[t + 11]] + c[e[t + 12]] + c[e[t + 13]] + c[e[t + 14]] + c[e[t + 15]]).toLowerCase();
                if (!a(r)) throw TypeError("Stringified UUID is invalid");
                return r;
            };
            var f, p, l = 0, d = 0;
            const y = function(e, t, r) {
                var n = t && r || 0, o = t || new Array(16), s = (e = e || {}).node || f, a = void 0 !== e.clockseq ? e.clockseq : p;
                if (null == s || null == a) {
                    var c = e.random || (e.rng || i)();
                    null == s && (s = f = [ 1 | c[0], c[1], c[2], c[3], c[4], c[5] ]), 
                    null == a && (a = p = 16383 & (c[6] << 8 | c[7]));
                }
                var u = void 0 !== e.msecs ? e.msecs : Date.now(), y = void 0 !== e.nsecs ? e.nsecs : d + 1, g = u - l + (y - d) / 1e4;
                if (g < 0 && void 0 === e.clockseq && (a = a + 1 & 16383), (g < 0 || u > l) && void 0 === e.nsecs && (y = 0), 
                y >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
                l = u, d = y, p = a;
                var v = (1e4 * (268435455 & (u += 122192928e5)) + y) % 4294967296;
                o[n++] = v >>> 24 & 255, o[n++] = v >>> 16 & 255, o[n++] = v >>> 8 & 255, 
                o[n++] = 255 & v;
                var m = u / 4294967296 * 1e4 & 268435455;
                o[n++] = m >>> 8 & 255, o[n++] = 255 & m, o[n++] = m >>> 24 & 15 | 16, 
                o[n++] = m >>> 16 & 255, o[n++] = a >>> 8 | 128, o[n++] = 255 & a;
                for (var w = 0; w < 6; ++w) o[n + w] = s[w];
                return t || h(o);
            }, g = function(e) {
                if (!a(e)) throw TypeError("Invalid UUID");
                var t, r = new Uint8Array(16);
                return r[0] = (t = parseInt(e.slice(0, 8), 16)) >>> 24, r[1] = t >>> 16 & 255, 
                r[2] = t >>> 8 & 255, r[3] = 255 & t, r[4] = (t = parseInt(e.slice(9, 13), 16)) >>> 8, 
                r[5] = 255 & t, r[6] = (t = parseInt(e.slice(14, 18), 16)) >>> 8, 
                r[7] = 255 & t, r[8] = (t = parseInt(e.slice(19, 23), 16)) >>> 8, 
                r[9] = 255 & t, r[10] = (t = parseInt(e.slice(24, 36), 16)) / 1099511627776 & 255, 
                r[11] = t / 4294967296 & 255, r[12] = t >>> 24 & 255, r[13] = t >>> 16 & 255, 
                r[14] = t >>> 8 & 255, r[15] = 255 & t, r;
            };
            function v(e, t, r) {
                function n(e, n, o, i) {
                    ...
                    if (s.set(n), s.set(e, n.length), (s = r(s))[6] = 15 & s[6] | t, 
                    s[8] = 63 & s[8] | 128, o) {
                        i = i || 0;
                ...
                return n.DNS = "6ba7b810-9dad-11d1-80b4-00c04fd430c8", n.URL = "6ba7b811-9dad-11d1-80b4-00c04fd430c8", 
                n;
            }
            function m(e) {
            ...
            const P = v("v3", 48, function(e) {
                ...
                return function(e) {
                    for (var t = [], r = 32 * e.length, n = "0123456789abcdef", o = 0; o < r; o += 8) {
                        var i = e[o >> 5] >>> o % 32 & 255, s = parseInt(n.charAt(i >>> 4 & 15) + n.charAt(15 & i), 16);
                        t.push(s);
                    }
                    return t;
                }(function(e, t) {
                    ...
                    for (var r = 1732584193, n = -271733879, o = -1732584194, i = 271733878, s = 0; s < e.length; s += 16) {
                        var a = r, c = n, u = o, h = i;
                        r = x(r, n, o, i, e[s], 7, -680876936), i = x(i, r, n, o, e[s + 1], 12, -389564586), 
                        o = x(o, i, r, n, e[s + 2], 17, 606105819), n = x(n, o, i, r, e[s + 3], 22, -1044525330), 
                        r = x(r, n, o, i, e[s + 4], 7, -176418897), i = x(i, r, n, o, e[s + 5], 12, 1200080426), 
                        o = x(o, i, r, n, e[s + 6], 17, -1473231341), n = x(n, o, i, r, e[s + 7], 22, -45705983), 
                        r = x(r, n, o, i, e[s + 8], 7, 1770035416), i = x(i, r, n, o, e[s + 9], 12, -1958414417), 
                        o = x(o, i, r, n, e[s + 10], 17, -42063), n = x(n, o, i, r, e[s + 11], 22, -1990404162), 
                        r = x(r, n, o, i, e[s + 12], 7, 1804603682), i = x(i, r, n, o, e[s + 13], 12, -40341101), 
                        o = x(o, i, r, n, e[s + 14], 17, -1502002290), r = _(r, n = x(n, o, i, r, e[s + 15], 22, 1236535329), o, i, e[s + 1], 5, -165796510), 
                        i = _(i, r, n, o, e[s + 6], 9, -1069501632), o = _(o, i, r, n, e[s + 11], 14, 643717713), 
                        n = _(n, o, i, r, e[s], 20, -373897302), r = _(r, n, o, i, e[s + 5], 5, -701558691), 
                        i = _(i, r, n, o, e[s + 10], 9, 38016083), o = _(o, i, r, n, e[s + 15], 14, -660478335), 
                        n = _(n, o, i, r, e[s + 4], 20, -405537848), r = _(r, n, o, i, e[s + 9], 5, 568446438), 
                        i = _(i, r, n, o, e[s + 14], 9, -1019803690), o = _(o, i, r, n, e[s + 3], 14, -187363961), 
                        n = _(n, o, i, r, e[s + 8], 20, 1163531501), r = _(r, n, o, i, e[s + 13], 5, -1444681467), 
                        i = _(i, r, n, o, e[s + 2], 9, -51403784), o = _(o, i, r, n, e[s + 7], 14, 1735328473), 
                        r = E(r, n = _(n, o, i, r, e[s + 12], 20, -1926607734), o, i, e[s + 5], 4, -378558), 
                        i = E(i, r, n, o, e[s + 8], 11, -2022574463), o = E(o, i, r, n, e[s + 11], 16, 1839030562), 
                        n = E(n, o, i, r, e[s + 14], 23, -35309556), r = E(r, n, o, i, e[s + 1], 4, -1530992060), 
                        i = E(i, r, n, o, e[s + 4], 11, 1272893353), o = E(o, i, r, n, e[s + 7], 16, -155497632), 
                        n = E(n, o, i, r, e[s + 10], 23, -1094730640), r = E(r, n, o, i, e[s + 13], 4, 681279174), 
                        i = E(i, r, n, o, e[s], 11, -358537222), o = E(o, i, r, n, e[s + 3], 16, -722521979), 
                        n = E(n, o, i, r, e[s + 6], 23, 76029189), r = E(r, n, o, i, e[s + 9], 4, -640364487), 
                        i = E(i, r, n, o, e[s + 12], 11, -421815835), o = E(o, i, r, n, e[s + 15], 16, 530742520), 
                        r = O(r, n = E(n, o, i, r, e[s + 2], 23, -995338651), o, i, e[s], 6, -198630844), 
                        i = O(i, r, n, o, e[s + 7], 10, 1126891415), o = O(o, i, r, n, e[s + 14], 15, -1416354905), 
                        n = O(n, o, i, r, e[s + 5], 21, -57434055), r = O(r, n, o, i, e[s + 12], 6, 1700485571), 
                        i = O(i, r, n, o, e[s + 3], 10, -1894986606), o = O(o, i, r, n, e[s + 10], 15, -1051523), 
                        n = O(n, o, i, r, e[s + 1], 21, -2054922799), r = O(r, n, o, i, e[s + 8], 6, 1873313359), 
                        i = O(i, r, n, o, e[s + 15], 10, -30611744), o = O(o, i, r, n, e[s + 6], 15, -1560198380), 
                        n = O(n, o, i, r, e[s + 13], 21, 1309151649), r = O(r, n, o, i, e[s + 4], 6, -145523070), 
                        i = O(i, r, n, o, e[s + 11], 10, -1120210379), o = O(o, i, r, n, e[s + 2], 15, 718787259), 
                        n = O(n, o, i, r, e[s + 9], 21, -343485551), r = w(r, a), 
                        n = w(n, c), o = w(o, u), i = w(i, h);
                    }
                    return [ r, n, o, i ];
                }(function(e) {
            ...
            const C = v("v5", 80, function(e) {
                ...
                a[s - 1][14] = 8 * (e.length - 1) / Math.pow(2, 32), a[s - 1][14] = Math.floor(a[s - 1][14]), 
                ...
                for (var f = 0; f < s; ++f) {
                    ...
                    for (var y = r[0], g = r[1], v = r[2], m = r[3], w = r[4], b = 0; b < 80; ++b) {
                        var x = Math.floor(b / 20), _ = A(y, 5) + j(x, g, v, m) + w + t[x] + p[b] >>> 0;
                        w = m, m = v, v = A(g, 30) >>> 0, g = y, y = _;
                    }
                    r[0] = r[0] + y >>> 0, r[1] = r[1] + g >>> 0, r[2] = r[2] + v >>> 0, 
                    r[3] = r[3] + m >>> 0, r[4] = r[4] + w >>> 0;
                }
            ...
            }), M = "00000000-0000-0000-0000-000000000000", T = function(e) {
                if (!a(e)) throw TypeError("Invalid UUID");
    ...
    r.n = e => {
        ...
        "use strict";
        var e, t = r(4654), n = r(7361), o = r.n(n);
        !function(e) {
            e.merchantSPBGetWindowPath = "merchantSPB:merchantSPBGetWindowPath", 
            e.merchantSPBCreateOrder = "merchantSPB:merchantSPBCreateOrder", e.merchantSPBApproveOrder = "merchantSPB:merchantSPBApproveOrder", 
            e.merchantSPBCancelOrder = "merchantSPB:merchantSPBCancelOrder", e.merchantSPBErrorOrder = "merchantSPB:merchantSPBErrorOrder", 
            e.merchantSPBGuestEnabled = "merchantSPB:merchantSPBGuestEnabled", e.merchantSPBGetFacilitatorAccessToken = "merchantSPB:merchantSPBGetFacilitatorAccessToken";
        }(e || (e = {}));
        const i = function(e) {
            const t = {};
