(() => {
    ...
    !function() {
        !function(e, n, t, s) {
                    ...
                    return new Promise((o, c) => {
                        ...
                        s ? (window.chrome.runtime.sendMessage(r), o()) : window.chrome.runtime.sendMessage(r, null, n => {
                            if (window.chrome.runtime.lastError) {
                                ...
                                n.sentMessage = r, c(n);
                            } else if (n.success) o(n.data); else {
                                const e = n && n.error, t = new Error(e && e.message);
                                t.sentMessage = r, e && (t.data = e.data, t.stack = `${t.stack || ""}${e.stack || ""}`), 
                                c(t);
                            }
                        });
                    }).catch(e => {
            ...
            n.src = window.chrome.runtime.getURL("/checkoutPaypal/merchantSPBResponders.js"), 
            n.setAttribute("data-iframeurl", e), (document.head || document.documentElement).appendChild(n);
        });
    }();
})();